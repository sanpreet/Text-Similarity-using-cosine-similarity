...
print("Text1", object_document_similar.cosine_sim('a little bird', 'a little bird'))
print("Text2", object_document_similar.cosine_sim('a little bird', 'a little bird chirps'))
print("Text3", object_document_similar.cosine_sim('a little bird', 'a big dog barks'))